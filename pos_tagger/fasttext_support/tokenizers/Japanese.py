...
# https://medium.com/@ykym2011/how-to-classify-japanese-text-with-fasttext-f9f3c8af4fa
...
class Japanese:
    def tokenize(self, s):
        import MeCab
        tagger = MeCab.Tagger('')  # TODO: Cache me!
        tagger.parse("")
        node = tagger.parseToNode(normalize_neologd(s))
        nouns = []
